-- Creating the StoreDB database
CREATE DATABASE StoreDB COLLATE Cyrillic_General_CI_AS;
...
VALUES (1, 'Brad Guzan', 'London', 100, 5),
		(2, 'Nick Rimando', 'New York', 100, 1),
		(3, 'Jozy Altidor', 'Moscow', 200, 7),
		(4, 'Fabian Johnson', 'Paris', 300, 6),
		(5, 'Graham Zusi', 'California', 200, 2),
		(6, 'Brad Davis', 'New York', 200, 1),
		(7, 'Julian Green', 'London', 300, 2),
		(8, 'Geoff Cameron', 'Berlin', 100, 3);
